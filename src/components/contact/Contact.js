...
const Contact = () => {
  ...
  return (
    <ScrollTrigger onEnter={() => setIsVisible(true)}>
      <div className={`contact-container ${isVisible ? 'visible' : ''}`} id='contact'>
        <div className='contact-title'>
          <span className='contact-title-number'>04.</span>
          <span className='contact-title-name'>Contact</span>
          <hr className='contact-title-line'></hr>
        </div>
        <div className='contact-info'>
          <span className='contact-calltoaction'>Get in Touch</span>
          <span className='contact-description'>hmu i want money please</span>
          ...
          <button className='resume-button'><a className='resume-tag-a' href={resume} target="_blank" rel='noreferrer'>Resume</a></button>
        </div>
      </div>
    </ScrollTrigger>
  )
