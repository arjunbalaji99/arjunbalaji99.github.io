  ...
  return (
    <div className='home-container'>
      ...
      <div className={`home-text-element description-home-text-container ${descClassVisible ? 'visible' : ''}`}>
        <span className='description-home-text-element'>I'm a student studying Computer Science at the University of Washington who loves coding, gaming, and playing basketball. I'm currently working as a developer at RetailRealm, building their XStreamPOS product's POS side.</span>
      </div>
